...
public:
	...
	FGameplayTag Abilities_Fire_Waterbolt;
	FGameplayTag Abilities_Fire_WaterArea;
	FGameplayTag Abilities_Fire_WaterFall;
	FGameplayTag Abilities_Fire_WaterRain;
	FGameplayTag Abilities_Fire_WaterSeed;
	FGameplayTag Abilities_Fire_WaterScan;
	FGameplayTag Abilities_Fire_WaterPurify;
	...
	FGameplayTag Cooldown_Fire_Waterbolt;
	FGameplayTag Cooldown_Fire_WaterArea;
	FGameplayTag Cooldown_Fire_WaterFall;
	FGameplayTag Cooldown_Fire_WaterRain;
	FGameplayTag Cooldown_Fire_WaterSeed;
	FGameplayTag Cooldown_Fire_WaterScan;
	FGameplayTag Cooldown_Fire_WaterPurify;
