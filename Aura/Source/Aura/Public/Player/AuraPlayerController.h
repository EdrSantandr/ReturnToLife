...
public:
	...
	UFUNCTION(BlueprintImplementableEvent, Category="CameraZoom")
	void CameraZoomIn();
...
private:
	...
	void ESCPressed() { bESCKeyDown = true;}
	void EscReleased();
	bool bESCKeyDown = false;

	void JumpPressed() { bJumpKeyDown = true;}
	void JumpReleased();
	bool bJumpKeyDown = false;

	void RmbPressed();
	void RmbReleased();
	bool bRmbKeyDown = false;
