...
void AAuraPlayerController::SetupInputComponent()
{
	...
	{
		AuraInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AAuraPlayerController::LookAt);	
	}
	...
	{
		AuraInputComponent->BindAction(ESCAction, ETriggerEvent::Started, this, &AAuraPlayerController::ESCPressed);
		AuraInputComponent->BindAction(ESCAction, ETriggerEvent::Completed, this, &AAuraPlayerController::EscReleased);
	}
	if (IsValid(F1Action))
	{
	...
	{
		AuraInputComponent->BindAction(JumpAction, ETriggerEvent::Started, this, &AAuraPlayerController::JumpPressed);
		AuraInputComponent->BindAction(JumpAction, ETriggerEvent::Completed, this, &AAuraPlayerController::JumpReleased);
	}
	if (IsValid(RmbAction))
	{
		AuraInputComponent->BindAction(RmbAction, ETriggerEvent::Started, this, &AAuraPlayerController::RmbPressed);
		AuraInputComponent->BindAction(RmbAction, ETriggerEvent::Completed, this, &AAuraPlayerController::RmbReleased);
	}
...
void AAuraPlayerController::LookAt(const FInputActionValue& InputActionValue)
{
...
void AAuraPlayerController::EscReleased()
{
	bESCKeyDown = false;
	ConsoleCommand("quit");
}
...
void AAuraPlayerController::RmbReleased()
{
	CameraZoomOut();
	bRmbKeyDown = false;
}
